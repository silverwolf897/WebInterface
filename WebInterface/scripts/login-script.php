<?php
	...
	if ($count==1){
		...
		if ($playerRow[4] == 1){$_SESSION['Admin'] = "true";}else{$_SESSION['Admin'] = "false";}
		if ($playerRow[5] == 1){$_SESSION['canBuy'] = "true";}else{$_SESSION['canBuy'] = "false";}
		if ($playerRow[6] == 1){$_SESSION['canSell'] = "true";}else{$_SESSION['canSell'] = "false";}
